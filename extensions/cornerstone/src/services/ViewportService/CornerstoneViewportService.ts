  ...
  private performResize() {
    ...
    try {
      ...
      viewports.forEach(({ id: viewportId }) => {
        ...
        // @BMPATCH
        // https://github.com/OHIF/Viewers/blob/543aa137dc691f557ee5098f035c99f3cbc687ed/extensions/cornerstone/src/services/ViewportService/CornerstoneViewportService.ts
